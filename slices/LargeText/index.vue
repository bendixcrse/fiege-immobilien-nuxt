...
defineProps(
  getSliceComponentProps<Content.LargeTextSlice>(["slice", "index", "slices", "context"])
);
</script>
...
<template>
  ...
  >
    <div class="bx-large-text-container">
      <div
        v-if="slice.primary.side_text"
        class="bx-side-text animate--slide-in scroll-trigger"
      >
      ...
      <div class="bx-text-container animate--slide-in scroll-trigger">
        ...
        <PrismicRichText
          ...
          class="bx-text"
        />
        <Button class="bx-button" :link="slice.primary.button" />
      </div>
    </div>
  </section>
</template>
